...
<section class="section-carousel l-banner">
	<div id="banner-slider" class="carousel slide banner-slider" data-ride="carousel">
	  ...
	  <a class="left carousel-control photos-control-left home-slider1" href="#banner-slider" role="button" data-slide="prev">
	    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
	    <span class="sr-only">Previous</span>
	  </a>
	  <a class="right carousel-control photos-control-right home-slider1" href="#banner-slider" role="button" data-slide="next">
