		...
		<div class="row">
			<div class="col-md-7 skin-white-services">
				<div class="title-heading">
					<h2 class="title">SotoGrande Hotel and Resort</h2>
				</div>

				<div class="copy properties-body">
					<p class="properties-body-gap">
					...
					<div class="tab-content section-single-content">
					  <div role="tabpanel" class="tab-pane active" id="facilities">
					  	<div class="copy section-single-content-par">
					  		...
					  		<h4 class="copy-title">Restaurant</h4>
					  		<p>
					  			Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor 
								in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
					  		</p>

					  		<h4 class="copy-title">GYM/fitness centre</h4>
					  		<p>
					  			Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor 
								in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
					  		</p>

					  		<h4 class="copy-title">non smoking rooms</h4>
					  		<p>
					  			Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor 
								in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
					  		</p>
